...
# NFC
PRODUCT_COPY_FILES += \
    device/asus/Z00A/nfc/ze551_gold_libnfc-brcm.conf:system/etc/ze551_gold_libnfc-brcm.conf \
    device/asus/Z00A/nfc/ze551ml_gold_libnfc-brcm-20795a20.conf:system/etc/ze551ml_gold_libnfc-brcm-20795a20.conf \
    device/asus/Z00A/nfc/ze551_tweccclm_libnfc-brcm.conf:system/etc/ze551_tweccclm_libnfc-brcm.conf \
    device/asus/Z00A/nfc/ze551ml_tweccclm_libnfc-brcm-20795a20.conf:system/etc/ze551ml_tweccclm_libnfc-brcm-20795a20.conf \
    device/asus/Z00A/nfc/ze551_tweccplm_libnfc-brcm.conf:system/etc/ze551_tweccplm_libnfc-brcm.conf \
    device/asus/Z00A/nfc/ze551ml_tweccplm_libnfc-brcm-20795a20.conf:system/etc/ze551ml_tweccplm_libnfc-brcm-20795a20.conf \
    device/asus/Z00A/nfc/zx551_gold_libnfc-brcm.conf:system/etc/zx551_gold_libnfc-brcm.conf \
